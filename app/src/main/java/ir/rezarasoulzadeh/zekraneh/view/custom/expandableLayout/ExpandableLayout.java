package ir.rezarasoulzadeh.zekraneh.view.custom.expandableLayout;
...
public class ExpandableLayout extends FrameLayout {
    ...
    private void animateSize(int targetExpansion) {
        ...
        Animator.AnimatorListener expansionListener = new ExpansionListener(ExpandableLayout.this, targetExpansion);


        animator.addListener(new ExpansionListener(ExpandableLayout.this, targetExpansion));

        animator.start();
    }

    public void setState(int targetExpansion) {
        this.state = targetExpansion == 0 ? State.COLLAPSING : State.EXPANDING;
    }
